$(document).ready(function() {
  ...
  test("same", function() {
    equal(_.same(['0', '1', '2'], ['1', '0', '2']), true, 'compare two arrays with same items but different order');
    equal(_.same(['0', '1', '2'], ['1', '0']), false, 'compare two arrays with different item amount');
    equal(_.same(['0', '1', '2'], ['1', '0', '2'], ['2', '0', '1']), false, 'compare three arrays with same items in different order');
    equal(_.same([0, 1, 2], [1, 0, 2], [2, 0, 1]), false, 'compare three arrays with same items in different order');
  });
